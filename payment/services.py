...
def get_checkout_session(borrowing: Borrowing, payment_id: int) -> Session:
    ...
    success_url = reverse("payment:payments-success", args=[payment_id])
    cancel_url = reverse("payment:payments-cancel", args=[payment_id])
...
def successful_payment_notification(payment: Payment) -> None:
    ...
    try:
        run_telegram_bot.send_notification(
